Ext.Loader.loadScript({url:G_PATH + '/ui/based/board/controller/BoardCore.js'});
Ext.define('Ui.based.board.controller.Board', {
    ...
    gridCellClick : function(table, td, cellIndex, record, tr, rowIndex, e, eOpts) {
    	...
    	if (grid.columns[cellIndex-1].dataIndex == 'fileView')  {
    	...
    	} else if (grid.columns[cellIndex-1].dataIndex == 'detailView') {
    		var data = record.getData();
    		var win = Ext.getCmp('board-detail');
    		...
    		win = Ext.create('Ext.window.Window', {
        	    ...
        	    layout: 'fit',
        	    animateTarget:this,
        	    html : '<center><div style="padding: 10 10 10 10;"><p>' + data.boardDescription + '</h2><div></center>',
        	    listeners : {
    ...
    removeFile : function() {
    	...
    	if (sm.getSelection().length == 0) {
    		Ext.MessageBox.alert("Info", "삭제할 대상 파일을 선택하십시오.");
    		return ;
    	}
