Ext.define('Ext.qualityhist.store.UnderStatementChart', {
    extend: 'Ext.data.Store',
    model: 'Ext.qualityhist.model.ChartData',
    autoDestroy: true,
    proxy: {
        type: 'ajax',
        url: '/int/quality/history/chart/get.json',
        headers: {
        ...
        extraParams : { maxRowSize : 0, searchType : 'underStatement' }
    },
    autoLoad : true,
    listeners : {
    	load: function( store, records, successful, eOpts ) {
    		var chart = Ext.getCmp('understatement-chart');
    		var series = [];
    		var titles = [];
    		var yFields = [];
    		var rec = records[0];
