...
public class BasedResource extends Common {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -8208973549827003381L;
	...
	public String getResourceKey() {
		...
		} else if(this.getResourceTypeCode().equals("PAGE")) {
			return this.getUrl();
		} else if (this.getResourceTypeCode().equals("CONTENT")) {
			return this.getUrl();
		}
		return null;
	}
