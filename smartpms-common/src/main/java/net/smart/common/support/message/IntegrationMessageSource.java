 ...
 *
 */
public class IntegrationMessageSource {
	private static  Logger logger = LoggerFactory.getLogger(IntegrationMessageSource.class);
	...
	public void setMessageSource(MessageSource messageSource) {
		IntegrationMessageSource.messageSource = messageSource;
	}
